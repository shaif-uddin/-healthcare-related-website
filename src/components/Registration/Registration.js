  ...
  return (
    <>
      <div className="container p-5">
        ...
        <Button onClick={handleGoogleSignIn} variant="secondary" size="sm">Google Login</Button>
        <Button onClick={handleGithubSignIn} variant="secondary" size="sm" className="ms-2">Github Login</Button>
      </div>
    </>
  );
};
